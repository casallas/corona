...
echo '<table>';
mailing_list('corona-annc', '7924', 'Announcements and news related to Corona.  ' .
             'This is a low-volume list for those who are only interested in ' .
             'new releases.');
mailing_list('corona-users', '8226', 'User information and discussion.  Use this list ' .
             'to get in contact with other Corona users.');
mailing_list('corona-devel', '7943', 'Developer discussion.  This list is for discussion ' .
             'about the development process and other topics the average user ' .
             'does not care about.  Use this list to reach the developers.');
mailing_list('corona-commits', '7678', 'Relatively high-volume list that logs all CVS ' .
